...
function MyOrder () {
        ...
        return(
        <section className="myorders-container bg-slate-50 h-screen ">
            <div className="myorders--header flex items-center gap-8 pt-8">
                <h2 className="header-title"> My Order</h2>
                <p className=" text-gray-500 text-sm ">view your pending delivered, <br/> and returned orders here.</p>
            </div>
            ...
            <div className="myorder-card--container bg-white p-8 pb-0 shadow-lg">
                ...
                <div>
                    ...
                    { 
                        ...
                        order != undefined ?  order?.items?.map(item => (
                            ...
                            <div key={item?.id} className="checkout-menu--product py-4 h-auto mb-0">
                        ...
                        )) : <div className='heigth-200 h-20 flex items-center font-bold '> Add Products</div> 
                ...
                <div className="flex justify-between h-12  items-center">
                    ...
                    <p className=" text-gray-600 text-xs">Paid using credit card ending with 9898</p>
